...
class TranslationChoiceType extends AbstractType
{
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        ...
        $choiceList = function (Options $options) use ($that) {
            return new SimpleChoiceList($that->getTranslations($options['translation_domain'], $options['locale']));
        };
    ...
    public function getTranslations($domain, $locale)
    {
        return $this->translator->all($domain, $locale);
    }
